...
#ifndef INCLUDE_PCI_DEVICE_RESOLVER_H
#define INCLUDE_PCI_DEVICE_RESOLVER_H
...
class PCIDeviceResolver : public DeviceResolver
{
	public:
		PCIDeviceResolver();
		virtual ~PCIDeviceResolver();
